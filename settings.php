 ...
 * @endcode
 */
$settings['hash_salt'] = 'KSK30T1jwoHFAl_H76FUl8-4qdisAQwPhXWEyX42iQd6JsoUePR1mHYa3L5UI_Dp4yu1vxgjzg';
...
if (file_exists('../settings')) {
  require('../settings/jordankatherine_com-settings.inc');
}
$config_directories['sync'] = 'sites/jordankatherine.com/config/sync';
